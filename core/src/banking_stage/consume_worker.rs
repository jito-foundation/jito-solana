...
>>>>>>> 13bdebd86a (banking_stage: fix BAM tip refresh and simplify scheduler plumbing (#1626))
        ...
        let output = self
            ...
            .process_and_record_aged_transactions_with_policy(
                ...
                // Greedy checks bundle locks while scheduling. Queued BAM work can overlap
                // BundleStage after disconnect; Bank account locks prevent conflicting execution.
                None,
...
>>>>>>> 13bdebd86a (banking_stage: fix BAM tip refresh and simplify scheduler plumbing (#1626))
    ...
    fn test_tip_preparation_precedes_bam_admission(
        ...
        scheduler.schedule(&mut container, u64::MAX).unwrap();
