...
mod tests {
    ...
    fn test_bundle_entry_bytes_budget(exact_boundary: bool) {
        ...
        if exact_boundary {
            ...
            // Each entry of the bundle is sent as its own record on this
            // release line (record_batch); master coalesces them into a
            // single record carrying transaction_batches.
