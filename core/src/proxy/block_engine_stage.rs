...
impl BlockEngineStage {
    ...
    fn handle_block_engine_maybe_bundles(
        ...
        let bundles: Vec<PacketBundle> = bundles_response
            ...
            .filter_map(|bundle| {
                Some(PacketBundle {
                    batch: proto_packets_to_packet_batch(bundle.bundle?.packets.into_iter()),
    ...
    fn handle_block_engine_packets(
        ...
        if let Some(batch) = resp.batch {
            ...
            let packet_batch = proto_packets_to_packet_batch(batch.packets.into_iter());
