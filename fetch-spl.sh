...
# jito programs
add_spl_program_to_fetch jito_tip_payment 0.1.7 T1pyyaTNZsKv2WcRAB8oVnk93mLJw2XzjtVYqCsaHqt BPFLoaderUpgradeab1e11111111111111111111111 jito
add_spl_program_to_fetch jito_tip_distribution 0.1.7 4R3gSG8BpU4t19KYj8CfnbtRpnT8gtk4dvTHxVRwc2r7 BPFLoaderUpgradeab1e11111111111111111111111 jito
