...
impl PohRecorder {
    ...
    pub(crate) fn record(
        ...
        loop {
            ...
            self.metrics.record_us += record_mixin_time_us;
            ...
            if let Some(entries) = maybe_entries {
                ...
                let (_, send_entry_time_us) = measure_us!({
                    let entries_tick_heights = entries
                        .into_iter()
                    ...
                    for entries_ticks in entries_tick_heights {
                        self.working_bank_sender
                            .send((working_bank.bank.clone(), entries_ticks))?;
                    }
                });
