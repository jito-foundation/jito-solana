...
fn alt_bn128_g1_addition_be_test() {
    // chfast1
...
fn alt_bn128_g1_addition_le_test() {
...
fn alt_bn128_g2_addition_be_test() {
    let result = alt_bn128_g2_addition_be(&[
        ,
    ]);
    assert!(result.is_ok());
    assert_eq!(
        result.unwrap(),
        &[
            ,
        ]
    );
}

fn alt_bn128_g2_addition_le_test() {
    let result = alt_bn128_g2_addition_le(&[
        0x75, 0x90, 0x78, 0x28, 0xb6, 0xc6, 0x7, 0x7f, 0xed, 0x48, 0xf8, 0xb4, 0x12, 0xc6, 0x48,
        0xa1, 0x1c, 0x27, 0xe8, 0xba, 0xa2, 0xb1, 0xd9, 0x19, 0xe5, 0xfa, 0x94, 0xe, 0xc2, 0x7e,
        0x4a, 0x16, 0xff, 0x18, 0xd9, 0x7d, 0x6d, 0x51, 0x52, 0xc2, 0x56, 0xe, 0x83, 0x6b, 0xdb,
        0x44, 0x8f, 0xc1, 0x5a, 0xda, 0xff, 0x88, 0xda, 0xae, 0x13, 0x2, 0x7b, 0xd2, 0xdb, 0xc3,
        0x9, 0x79, 0x63, 0xc, 0xae, 0xa, 0xfc, 0xd4, 0x16, 0x89, 0xc, 0xf4, 0x99, 0xf3, 0x8a, 0x1c,
        0x9d, 0xd9, 0x8c, 0x24, 0xdc, 0x76, 0x1e, 0x9, 0x39, 0x72, 0x7, 0x51, 0x46, 0x8c, 0xfc,
        0xdb, 0xa1, 0x43, 0x5f, 0x2, 0xe7, 0xc7, 0x6, 0xd6, 0x4c, 0xa5, 0x6c, 0xc6, 0xdc, 0x9,
        0xf7, 0x88, 0x99, 0xf0, 0x81, 0xad, 0xf2, 0x5a, 0x63, 0x8e, 0xdb, 0x48, 0x57, 0xac, 0x75,
        0xf, 0x64, 0xd7, 0x1, 0x19, 0xde, 0x2, 0x6d, 0x21, 0x2b, 0xc9, 0x84, 0x5c, 0x79, 0xaf,
        0x3c, 0xda, 0x4f, 0x19, 0x12, 0x43, 0xf8, 0xba, 0xb0, 0xad, 0xff, 0x74, 0x43, 0x13, 0x17,
        0x3e, 0xc8, 0x70, 0x14, 0x33, 0x74, 0x20, 0xb6, 0x19, 0xb0, 0xc8, 0xbc, 0x35, 0xea, 0x7a,
        0x2c, 0xdd, 0x6e, 0xa0, 0x78, 0xa2, 0x8d, 0x4e, 0x7c, 0x91, 0x44, 0xab, 0x7f, 0xa6, 0x95,
        0x7b, 0xdd, 0x59, 0xe9, 0x25, 0xd8, 0x90, 0xf1, 0x3a, 0x92, 0x7, 0x7a, 0xcc, 0x7, 0x80,
        0x76, 0x17, 0x28, 0x71, 0x6f, 0xcf, 0xd1, 0xe0, 0x48, 0x3, 0x80, 0x6e, 0xc0, 0xe0, 0x2a,
        0xeb, 0x4a, 0x22, 0x9b, 0x82, 0x71, 0x2, 0x76, 0xbb, 0x42, 0xeb, 0xe9, 0x15, 0x49, 0xac,
        0xcf, 0xd0, 0x7d, 0x5d, 0xd3, 0x80, 0xc1, 0xdd, 0xa6, 0x14, 0xc7, 0xdc, 0x3c, 0x67, 0xe8,
        0x2, 0x83, 0x28, 0x3a, 0x98, 0xd9, 0x68, 0xc4, 0x11, 0x55, 0x47, 0xcd, 0x8b, 0xee, 0x11,
    ]);
    assert!(result.is_ok());
    assert_eq!(
        result.unwrap(),
        &[
            0x80, 0x19, 0x78, 0x10, 0xe1, 0xf5, 0xa8, 0x97, 0x36, 0x78, 0x40, 0x9a, 0x84, 0x1,
            0x8f, 0xc5, 0x98, 0x2b, 0x21, 0xaa, 0xbd, 0x51, 0x94, 0x57, 0xb7, 0xc1, 0x9f, 0xf8,
            0x15, 0x70, 0x66, 0x2e, 0x8a, 0xf2, 0xd5, 0x66, 0x9c, 0xb3, 0x31, 0xb7, 0x7d, 0x91,
            0x70, 0x85, 0x53, 0x11, 0x26, 0xa8, 0x6c, 0xb5, 0x8f, 0x25, 0x51, 0xc2, 0x1, 0x0, 0x90,
            0xca, 0x5c, 0x3c, 0xc0, 0x7d, 0x5f, 0x26, 0x2f, 0x1c, 0x76, 0xa3, 0x75, 0xc0, 0xbc,
            0xf1, 0xc4, 0xd1, 0xfe, 0x9d, 0x16, 0x2d, 0xc, 0x5f, 0xa4, 0x59, 0x20, 0x25, 0x67,
            0xd2, 0xb2, 0x68, 0x90, 0x81, 0xa1, 0x4, 0x83, 0x44, 0xfe, 0x29, 0x22, 0x81, 0xab,
            0x1d, 0xb2, 0x1e, 0x45, 0xd8, 0xd8, 0x8c, 0xb, 0xa4, 0xa2, 0xa2, 0xee, 0x4c, 0x49,
            0xfb, 0x36, 0xa, 0x7a, 0xc0, 0xa1, 0x2, 0x97, 0xea, 0x0, 0xfa, 0x87, 0xac, 0x8, 0x16,
        ]
    );
}

fn alt_bn128_g1_multiplication_be_test() {
    // chfast1
...
fn alt_bn128_g1_multiplication_le_test() {
...
fn alt_bn128_g2_multiplication_be_test() {
    let result = alt_bn128_g2_multiplication_be(&[
        ,
    ]);
    assert!(result.is_ok());
    assert_eq!(
        result.unwrap(),
        &[
            ,
        ]
    );
}

fn alt_bn128_g2_multiplication_le_test() {
    let result = alt_bn128_g2_multiplication_le(&[
        0x86, 0x78, 0xdb, 0xbd, 0x50, 0xa4, 0x9a, 0x26, 0xf8, 0x60, 0x14, 0xe4, 0x18, 0xce, 0xa,
        0x61, 0x43, 0xfe, 0xc1, 0x5c, 0x3e, 0x98, 0xd7, 0xd1, 0xbc, 0xaf, 0xeb, 0x76, 0xcb, 0xe1,
        0x3f, 0x7, 0x25, 0x79, 0x31, 0x23, 0xa0, 0x93, 0xe1, 0xec, 0xb8, 0x16, 0x36, 0x29, 0xe,
        0x39, 0x4e, 0x6e, 0xa2, 0x58, 0x66, 0xe5, 0x3b, 0xef, 0x11, 0xd6, 0xcd, 0x69, 0x57, 0xd9,
        0xa5, 0x6e, 0xb9, 0x24, 0x5a, 0xe8, 0xf5, 0xfa, 0xeb, 0x7, 0x13, 0xa9, 0x8a, 0xe2, 0xa5,
        0x60, 0xfa, 0x2e, 0x7f, 0x49, 0xb, 0x88, 0x6c, 0x3, 0x97, 0xec, 0x29, 0x3c, 0x40, 0x2e,
        0xf, 0xe3, 0x52, 0x5a, 0x5a, 0x8, 0xb9, 0xf7, 0x25, 0x30, 0x12, 0x8b, 0x60, 0x5, 0x2a,
        0xbd, 0xf, 0xb4, 0xcc, 0xb5, 0xd6, 0x86, 0x6f, 0x84, 0xf1, 0x34, 0x25, 0xce, 0x77, 0x70,
        0x73, 0x94, 0x63, 0xfe, 0x19, 0x67, 0x8d, 0x0, 0x85, 0x95, 0x35, 0x68, 0x80, 0x3a, 0xa0,
        0x9, 0xb5, 0x12, 0x2f, 0x9d, 0x3e, 0x53, 0x66, 0x3, 0x5f, 0x68, 0x9e, 0x2f, 0x45, 0x67,
        0x6c, 0x29, 0xb7, 0xe9, 0xd9, 0x89, 0x2b, 0x9b, 0xea, 0x9,
    ]);
    assert!(result.is_ok());
    assert_eq!(
        result.unwrap(),
        &[
            0x42, 0x52, 0xa0, 0x21, 0x9a, 0x21, 0x13, 0x2f, 0xf1, 0xcc, 0x3d, 0xed, 0x70, 0x29,
            0xa2, 0xd4, 0x7, 0xf2, 0x65, 0xae, 0x8a, 0x43, 0xfd, 0x6e, 0x92, 0x4f, 0xa1, 0xd7,
            0x64, 0xc7, 0x6, 0x27, 0x2d, 0x95, 0xae, 0xc8, 0xd0, 0x9a, 0x5c, 0xb2, 0xc3, 0xa2,
            0x46, 0xea, 0x36, 0xad, 0x6e, 0xb2, 0x9, 0x99, 0x4c, 0x86, 0x84, 0xbf, 0xf4, 0x5, 0x8f,
            0x79, 0x2d, 0x5f, 0xb0, 0x13, 0x65, 0x10, 0x1e, 0xf3, 0xc3, 0x8a, 0xb3, 0x55, 0x84,
            0xef, 0x42, 0xaf, 0x99, 0x4f, 0xf0, 0x57, 0xd7, 0xb, 0xb5, 0x1, 0xf, 0x67, 0x29, 0xd6,
            0x9, 0xdf, 0x89, 0x50, 0x9c, 0x7a, 0x94, 0xf2, 0x8a, 0xe, 0xd, 0xb2, 0xc9, 0x4, 0x93,
            0xbf, 0xf7, 0x3a, 0x92, 0xec, 0xb8, 0xfa, 0x71, 0xfa, 0xa9, 0xd, 0x34, 0x6e, 0x33,
            0x28, 0xcc, 0xd, 0x1b, 0x47, 0x6c, 0xcd, 0xb0, 0x47, 0x2d, 0x60, 0xa, 0x12,
        ]
    );
}
...
pub extern "C" fn entrypoint(_input: *mut u8) -> u64 {
    ...
    alt_bn128_g1_addition_be_test();
    alt_bn128_g1_addition_le_test();
    alt_bn128_g1_multiplication_be_test();
    alt_bn128_g1_multiplication_le_test();
    alt_bn128_g2_addition_be_test();
    alt_bn128_g2_addition_le_test();
    alt_bn128_g2_multiplication_be_test();
    alt_bn128_g2_multiplication_le_test();
