...
pub const TEST_CPI_INVALID_LAMPORTS_RC: u8 = 39;
pub const TEST_CPI_INVALID_DATA_RC: u8 = 40;
pub const TEST_READ_ACCOUNT: u8 = 42;
pub const TEST_WRITE_ACCOUNT: u8 = 43;
pub const TEST_CALLEE_ACCOUNT_UPDATES: u8 = 44;
pub const TEST_STACK_HEAP_ZEROED: u8 = 45;
