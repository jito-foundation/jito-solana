use {
    ...
    solana_program::{
        ...
        stake::state::StakeStateWithFlags, system_program,
    },
...
pub fn claim_mev_tips(
    ...
    runtime.block_on(async move {
        ...
        let stake_acct_min_rent = rpc_client.get_minimum_balance_for_rent_exemption(StakeStateWithFlags::size_of()).await.expect("Failed to calculate min rent");
